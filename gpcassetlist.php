<?php 
	...
	function printAssetRow($asset) {
		echo '<tr>';
		echo "<td>";
		echo "<a class='btn btn-primary btn-xs' data-toggle='modal' data-target="."#".htmlentities($asset['gpc_asset_tag'])."view href="."#".htmlentities($asset['gpc_asset_tag'])."view><i class='fa fa-folder'></i> View </a>";
		echo "<a href=\"editgpcasset.php?id=".htmlentities($asset['gpc_asset_tag'])."\" class=\"btn btn-info btn-xs\"><i class='fa fa-edit'></i>Edit</a>";
		echo "</td>";
